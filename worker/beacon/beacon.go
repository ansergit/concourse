...
func (beacon *Beacon) registerDirect(ctx context.Context, disableKeepAliveCtx context.Context) error {
	...
	return beacon.registerRun("register-worker", ctx, disableKeepAliveCtx)
}
...
func (beacon *Beacon) registerRun(command string, ctx context.Context, disableKeepAliveCtx context.Context) error {
	beacon.Logger.Debug("command-to-run", lager.Data{"cmd": command})
